...
local t = Def.ActorFrame{
	...
	LoadActor("_panel")..{
		...
		OnCommand=cmd(valign,1;diffusealpha,0;sleep,1.1;diffusealpha,0;linear,0.1;diffusealpha,1;zoomy,1;zoomy,1.2;accelerate,0.066;zoomy,1);
	...
	LoadActor("dancer"..masterPlayer)..{
		...
		OnCommand=cmd(valign,1;diffusealpha,0;sleep,1.333;linear,0.117;diffusealpha,1;zoomy,1.2;accelerate,0.066;zoomy,1);
		GainFocusCommand=cmd(stoptweening;visible,true);
		LoseFocusCommand=cmd(stoptweening;visible,false);

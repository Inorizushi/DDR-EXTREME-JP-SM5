...
t[#t+1] = Def.ActorFrame{
    ...
    Def.Sprite{ Texture=THEME:GetPathB("","ScreenProfileLoad overlay/"..lang.."_Warning3"),
        InitCommand=function(s) s:xy( -140,0 ) end
    };
    Def.Sprite{ Texture=THEME:GetPathB("","ScreenProfileLoad overlay/"..lang.."_Warning4"),
...
t[#t+1] = Def.ActorFrame{
    ...
    Def.Sprite{ Texture=lang.."_Warning3",
        InitCommand=function(s) s:xy( -110,0 ) end
    };
    Def.Sprite{ Texture=lang.."_Warning5",
...
t[#t+1] = Def.ActorFrame{
	...
	CardSavedCommand=function(s) s:stoptweening():linear(0.2):zoom(1):linear(0.110):y(SCREEN_CENTER_Y+80) end,
	OffCommand=function(s)
		s:decelerate(0.2):y(SCREEN_CENTER_Y-10)
	end,
	BounceCommand=function(s)
		s:stoptweening()
		s:decelerate(0.3):zoom(0.7)
		:accelerate(0.2):zoom(0.9)
		:decelerate(0.2):zoom(1)
		:accelerate(0.2):zoom(0.9)
		-- :decelerate(0.3):zoom(1)
		:queuecommand("Bounce")
	end,
	Def.Sprite{
		Texture="../_moveon",
		...
		BounceCommand=function(s)
			s:stoptweening()
			s:spring(.6):zoomx(0.8):zoomy(1.2)
			:spring(.6):zoomx(1):zoomy(1)
			-- :spring(0.2):zoomx(1.1):zoomy(0.9)
			-- :accelerate(0.2):zoomx(1.1):zoomy(0.9)
			-- :decelerate(0.2):zoomx(1.05):zoomy(1.05)
			-- :decelerate(0.2):zoomx(1):zoomy(1)

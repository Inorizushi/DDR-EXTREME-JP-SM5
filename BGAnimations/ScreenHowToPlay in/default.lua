...
local LeftToRight = Def.ActorFrame{
	...
	Def.Quad{
		InitCommand=cmd(addx,64;diffuse,color("#000000FF");halign,0;zoomto,travelDist,32;blend,Blend.Add;);
	};
};
...
local RightToLeft = Def.ActorFrame{
	...
	Def.Quad{
		InitCommand=cmd(addx,-64;diffuse,color("#000000FF");halign,1;zoomto,travelDist,32;blend,Blend.Add;);
	};
};
...
return Def.ActorFrame{
	...
	LeftToRight..{
		...
		OnCommand=cmd(linear,0.5;addx,SCREEN_WIDTH*1.7);
	};
	LeftToRight..{

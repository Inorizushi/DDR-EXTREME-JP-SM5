...
t[#t+1] = LoadActor("explanation")..{ 
	InitCommand=cmd(x,SCREEN_LEFT+148;y,SCREEN_TOP+57;);
	OnCommand=cmd(cropleft,1;sleep,0.317;cropleft,0.78;addx,-208;sleep,0.183;linear,0.25;addx,208;cropleft,0);

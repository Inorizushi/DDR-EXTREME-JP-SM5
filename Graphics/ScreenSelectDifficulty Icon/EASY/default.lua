return Def.ActorFrame {
	LoadActor("choices")..{
		...
		SwitchToPage1Command=cmd(diffusealpha,1;sleep,0.2;linear,0.5;cropleft,0;cropright,0);
		SwitchToPage2Command=cmd(sleep,0.2;linear,0.5;cropleft,1;cropright,1;sleep,0;diffusealpha,0);
	};
};
